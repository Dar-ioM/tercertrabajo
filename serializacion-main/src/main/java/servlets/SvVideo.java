...
public class SvVideo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       FileOutputStream datosVideo = new FileOutputStream(getServletContext().getRealPath("listaVideos.data"), true);
        ObjectOutputStream escribir = new ObjectOutputStream (datosVideo);
        escribir.writeObject(miVideo);
        datosVideo.close();
        escribir.close();
        
        //Deserializar 
        FileInputStream leer = new FileInputStream(getServletContext().getRealPath("listaVideos.data"));
        //leer
